...
class AgentStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetHost = channel.unary_unary(
                '/agent.Agent/GetHost',
                request_serializer=agent__pb2.GetHostRequest.SerializeToString,
                response_deserializer=agent__pb2.GetHostResponse.FromString,
                _registered_method=True)
...
def add_AgentServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetHost': grpc.unary_unary_rpc_method_handler(
                    servicer.GetHost,
                    request_deserializer=agent__pb2.GetHostRequest.FromString,
                    response_serializer=agent__pb2.GetHostResponse.SerializeToString,
            ),
    }
...
class Agent(object):
    ...
    def GetHost(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/agent.Agent/GetHost',
            agent__pb2.GetHostRequest.SerializeToString,
            agent__pb2.GetHostResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
